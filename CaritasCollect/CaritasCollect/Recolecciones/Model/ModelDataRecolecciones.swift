...
func callApiCuentaCobrado(idRecolector: Int) -> Int {
    ...
    guard let url = URL(string:"http://10.14.255.69:10206/recolecciones?id=\(idRecolector)&estado=Cobrado") else{
...
func callApiCuentaNoCobrado(idRecolector: Int) -> Int {
    ...
    guard let url = URL(string:"http://10.14.255.69:10206/recolecciones?id=\(idRecolector)&estado=NoCobrado") else{
        return cantidadCobrado.recolecciones.count
    }
